...
"""?different from loan apr? - better to work out IRR"""
loan_interest=0.05
...
for j in range(len(elec_buy)):
    cost_elec_buy.append(elec_buy[j]*electricitycost)
    cost_elec_sell.append(elec_sell[j]*electricitycost)
    yearly_net.append(cost_elec_sell[j]-cost_elec_buy[j])
